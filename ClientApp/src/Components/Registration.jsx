...
function Registration() {
  ...
  const [userLogin, setUserLogin] = useState("andreyka26_");
  const [userPassword, setUserPassword] = useState("Mypass1*");
  ...
  const saveFile = (e) => {
    ...
    const verification = async (e) => {
      ...
      //   // const res = await axios.post("http://localhost:5267/api/MyRegistration/Verification", formData);
      //   alert(res);
      // }
      // catch (ex) {
      //   console.log(ex);
