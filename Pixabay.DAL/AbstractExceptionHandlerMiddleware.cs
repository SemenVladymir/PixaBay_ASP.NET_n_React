...
namespace Pixabay.DAL
{
    public abstract class AbstractExceptionHandlerMiddleware
    {
        ...
        private static readonly Microsoft.Extensions.Logging.ILogger Logger = (Microsoft.Extensions.Logging.ILogger)new LoggerConfiguration().CreateLogger().ForContext(MethodBase.GetCurrentMethod()?.DeclaringType);
